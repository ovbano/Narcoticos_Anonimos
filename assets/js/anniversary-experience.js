(() => {
  ...
  function renderDetail() {
    ...
    root.innerHTML=`<article class="ann-invitation">
      ...
      <section class="ann-invitation-hero"><div class="ann-hero-copy"><span class="ann-kicker">${past?'UNA HISTORIA QUE CELEBRAMOS':'TENEMOS UNA RAZÓN PARA REUNIRNOS'}</span><h1>Celebramos<br><em>la recuperación.</em></h1><div class="ann-invite-person"><span>CELEBRAMOS JUNTO A</span><h2>${esc(item.name)}</h2></div><p>Cada día es un nuevo comienzo.<br>Compartirlo lo hace aún más especial.</p><a class="ann-hero-link" href="#ann-invitation-info">Descubre la invitación <span aria-hidden="true">↓</span></a></div>
